export const siteConfig = {
  ...
  slogan: 'Streamline your dental practice with modern software solutions',
  url: 'https://dentech.com',
  ogImage: '/images/og.jpg',
  links: {
    twitter: 'https://twitter.com/dentech',
    github: 'https://github.com/dentech',
    calendly: 'https://calendly.com/dentech/demo'
  }
} 