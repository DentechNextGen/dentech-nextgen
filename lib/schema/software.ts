...
import {
  ...
  generateSoftwareWithReviewSchema,
} from "./review";
...
export const practiceManagementSchema = generateSoftwareWithReviewSchema(
  ...
  [
    {
      url: "/images/features/practice-management.webp",
...
export const voiceChartingSchema = generateSoftwareWithReviewSchema(
  ...
  [
    {
      url: "/images/services/voice-activated-charting.webp",
      caption: "Voice-Activated Charting Interface",
    },
  ],
  dentechAggregateRating
);
...
export const documentManagementSchema = generateSoftwareWithReviewSchema(
  ...
  [
    {
      url: "/images/services/document-management.webp",
...
export const patientCommunicationSchema = generateSoftwareWithReviewSchema(
  ...
  [
    {
      url: "/images/services/patient-communication.webp",
      caption: "Patient Communication Dashboard",
    },
  ],
  dentechAggregateRating
);
...
export const digitalImagingSchema = generateSoftwareWithReviewSchema(
  ...
  [
    {
      url: "/images/services/digital-imaging.webp",
      caption: "Digital Imaging Interface",
    },
  ],
  dentechAggregateRating
);
...
export const patientCheckInSchema = generateSoftwareWithReviewSchema(
  ...
  [
    {
      url: "/images/services/patient-check-in.webp",
      caption: "Patient Check-In System",
    },
  ],
  dentechAggregateRating
);
...
export const eservicesSchema = generateSoftwareWithReviewSchema(
  "Dentech Revenue Cycle Management",
  "Comprehensive suite of revenue cycle management solutions designed to simplify and scale your dental practice while reducing overhead costs. Includes seamless FastAttach integration for electronic claim attachments.",
  [
    "Electronic Claims",
    "Real-time Eligibility",
    "FastAttach Integration",
  ...
  [
    {
      url: "/images/services/eservices.webp",
      caption: "Revenue Cycle Management Dashboard",
    },
  ],
  dentechAggregateRating
);
