...
export const metadata: Metadata = {
  title: 'Features',
  description: 'Explore Dentech\'s comprehensive suite of dental practice management features, from voice-activated charting to advanced reporting.',
}
                  ...
                  <ul role="list" className="mt-4 space-y-2">
                    {feature.features.map((item) => (
                      <li key={item} className="flex gap-x-3">
                        <svg
                          className="h-6 w-5 flex-none text-accent-base"
                          viewBox="0 0 20 20"
                          fill="currentColor"
                          aria-hidden="true"
                        >
