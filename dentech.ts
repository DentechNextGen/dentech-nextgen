...
export const dentech: ISeedTenant = {
  tenant: {
    ...
    calendlyUrl: 'https://calendly.com/jane-kaminski/introductory-call',
...
– Jane E. Kaminski, CEO`,
    ...
    },
    {
      person: {
        firstName: 'Rennee',
        surname: 'Jackson',
        title: 'Dental Assistant of Bull City Dental',
        type: 'client',
      },
    },
  ],
  ...
  services: [
    {
      ...
      thumbnailFileName: 'practice-management.jpg',
      summary: 'Dental Practice Management Software Done Right',
      content: `"Our system offers advanced financial and patient reports, all conveniently housed in one place. With our easy insurance processing features, managing your patients' insurance claims becomes a breeze.",
...
`,
      ...
      media: [
        { type: EMediaType.IMAGE, name: 'practice-management.jpg' },
        { type: EMediaType.IMAGE, name: 'practice-management.jpg' },
    ...
    },
    {
      ...
      thumbnailFileName: 'voice-activated-charting.jpg',
      content: `
      ...
      itemType: 'SoftwareApplication',
      media: [
        { type: EMediaType.IMAGE, name: 'voice-activated-charting.jpg' },
    ...
    },
    {
      ...
      itemType: 'SoftwareApplication',
      media: [
        { type: EMediaType.IMAGE, name: 'document-management.jpg' },
      ...
      thumbnailFileName: 'document-management.jpg',
      content:
    ...
    },
    {
      ...
      itemType: 'SoftwareApplication',
      thumbnailFileName: 'patient-check-in.jpg',
      media: [
        { type: EMediaType.IMAGE, name: 'patient-check-in.jpg' },
    ...
    },
    {
      ...
      itemType: 'SoftwareApplication',
      thumbnailFileName: 'patient-communication.jpg',
      media: [
        { type: EMediaType.IMAGE, name: 'patient-communication.jpg' },
    ...
    },
    {
      ...
      itemType: 'SoftwareApplication',
      thumbnailFileName: 'digital-imaging.jpg',
      media: [
        { type: EMediaType.IMAGE, name: 'digital-imaging.jpg' },
    ...
    },
    {
      ...
      slug: 'eservices',
      thumbnailFileName: 'eservices.jpg',
      itemType: 'SoftwareApplication',
      media: [
        { type: EMediaType.IMAGE, name: 'eservices.jpg' },
    ...
    },
    {
      ...
      thumbnailFileName: 'managed-services.jpg',
      itemType: 'SoftwareApplication',
      media: [
        { type: EMediaType.IMAGE, name: 'managed-services.jpg' },
    ...
    },
    {
      ...
      thumbnailFileName: 'hardware-solutions.jpg',
      itemType: 'SoftwareApplication',
      media: [
        { type: EMediaType.IMAGE, name: 'hardware-solutions.jpg' },
        { type: EMediaType.IMAGE, name: 'managed-services-graphics-6.webp' },
      ],
      content:
        'On top of best-selling dental practice software like our Practice Management System, Dentech also gives you access to all the latest dental hardware for running your practice.\nWhether you’re opening a new practice or looking to update your existing hardware to the best available, our expert staff can guide you toward the right solutions for you and your business.',
      description:
        'Whether you’re opening a new practice or looking to update your existing hardware to the best available, our expert staff can guide you toward the right solutions for you and your business.',
      features: [
        {
...
`,
  ...
  pagesMetadata: [
    ...
    {
      type: 'services',
      title: 'Features That Directly Cater To Your Dental Practices Every Need',
      description:
        'Explore a wide range of features provided by Dentech. Our software offers Practice Management Solutions, Voice-Activated Charting, Document Management, Patient Check-In Systems, Patient Communication Tools, Digital Imaging Solutions, eServices, Managed Services, and Hardware Solutions. Find the software your dental practice needs.',
    },
    {
      type: 'blog',
      title: 'Blog',
...
`,
  ...
  contactStructuredData: {
    ...
    founders: [
      {
        name: 'Jane Kaminski',
        desc: 'Founder / Chief Operating Officer',
      },
    ],
    keywords:
      'Dental Practice Management Software, Dentech, Patient Check-In Solutions, Voice-Activated Dental Charting, Document Management for Dental Practices, Patient Communication Tools, Digital Imaging in Dentistry, Dental Eservices, Managed Services for Dental Practices, Dental Hardware Solutions, Dental Software, Practice Management for Dentists'.split(
  ...
  videoFeatures: [
    {
      ...
      imageNames: ['planning.jpg', 'inquiry.jpg'],
      features: [
        {
